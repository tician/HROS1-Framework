...
int InitPose[21] = {512, 512, 512, 512, 512, 512, 512, 512, 512, 512, 512, 512, 512, 512, 512, 512, 512, 512, 512, 512, 512};
		...
		if(id >= JointData::ID_R_SHOULDER_PITCH && id <= JointData::ID_HEAD_TILT)
		{
			if(cm730->ReadByte(id, MX28::P_TORQUE_ENABLE, &value, 0) == CM730::SUCCESS)
			{
				if(value == 1)
				{
				    ...
				    if(cm730->ReadTable(id, MX28::P_CW_COMPLIANCE_SLOPE, MX28::P_PRESENT_TEMPERATURE, table, 0) == CM730::SUCCESS)
				    {
				        ...
				        P_Gain[id] = table[MX28::P_PRESENT_TEMPERATURE];
				        I_Gain[id] = table[MX28::P_CW_COMPLIANCE_SLOPE];
				        D_Gain[id] = table[MX28::P_CCW_COMPLIANCE_SLOPE];
				    }
...
void DrawPage()
{
    ...
    printf( "                     GOAL  OFFSET MODVAL PRSPOS ERRORS _TEMP_ CW_SLP CCWSLP    \n" );//0
    printf( "]                                                                              " );  //1
