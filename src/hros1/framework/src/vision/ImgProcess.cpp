...
{
	int x, y, z, index;
	int *ytable = new int[img->m_Height];
...
{
	int x, y,z,index;
	int *ytable = new int[src->m_Height];
...
void ImgProcess::HFlipYUV(Image* img)
{
	...
	unsigned char *line = new unsigned char[sizeline];/*line buffer*/
...
//	unsigned char *pframe;
//	pframe=img->m_ImageData;
	unsigned char *line1 = new unsigned char[sizeline];/*line1 buffer*/
	unsigned char *line2 = new unsigned char[sizeline];/*line2 buffer*/
